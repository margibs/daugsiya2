   ...
   var $fortune = function(args) {
    ...
    fortune.spin = function(price) {
     /* price = typeof price === "number"?price:Math.floor(Math.random() * prices_amount);*/
      ...
      //GIBS MEN
      //var rand_number = Math.floor((Math.random() * 1000000000) + 1);
      ...
      /*if(rand_number >= 1 && rand_number <= 997000000)
      {
        price = 12;
        // $('#here').append('Common! <br />');
      }
      else if(rand_number >= 997000001 && rand_number <= 999000001)
      {
        price = 2;
        // $('#here').append('UNCOMMON! <br />');
        // console.log('UNCOMMON');
      }
      else if(rand_number >= 999000002 && rand_number <= 999990002)
      {
        price = 3;
        // $('#here').append('<span style="color:red;">RARE!</span> <br />');
        // console.log('RARE');
      }
      else if(rand_number >= 999990003 && rand_number <= 1000000000)
      {
        price = 4;
        // $('#here').append('<span style="color:red;">UNIQUE!</span> <br />');
        // console.log('UNIQUE');
      }
      else
      {
        price = 12;
        // $('#here').append('COMMON2! <br />');
        // console.log('COMMON2');
      }*/

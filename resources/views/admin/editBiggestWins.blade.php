...
@if($errors && count($errors) > 0)
					...
					@endif
<form action="{{ url('admin/biggest_wins/edit') }}/{{ $biggest_win->id }}" method="POST" class="form-horizontal">
					{!! csrf_field() !!}
						...
						<div class="col-xs-12 col-lg-6" style="padding: 20px 40px;">
							<div class="panel">
								...
								<div class="form-group">
											<h6> Search Game </h6> 
											<input type="text" class="form-control" id="search" autocomplete="off" value=" @if($biggest_win->post_id != 0) {{ $biggest_win->post->slug }} @endif ">
											<input type="hidden" name="post_id" id="post_id" value="{{ $biggest_win->post_id }}">
											<ul id="searchResults">
											</ul>
								...
								<div class="form-group">
											<div class="panel">
												  <h6> 
												   ...
												   @if($biggest_win->custom_image )
													<img src="{{ asset('uploads').'/'.$biggest_win->custom_image }}" alt="" style="display:block">
												   @else
												...
												<input id="image_url" type='hidden' name='custom_image' value="{{ $biggest_win->custom_image }}">
										</div>
								<div class="form-group">
									<h6>Total Wins</h6>
									<input type="number" name="total_wins" class="form-control" min="0.00" value="{{ $biggest_win->total_wins }}">
								</div>				

                                    ...
                                    <div class="form-group">
                                        <h6> Autonotify Date/Time </h6> 
                                         <input id='date' name="date_posting" class='input' type="text" value="{{ $custom_notification->date_posting }}"> 
                                          ...
                                          <div class="panel">
                                              <h6> 
                                               ...
                                               <div id="img_here">
                                                ...
                                                @if($custom_notification->image)
                                                    <img src="{{ url() }}/uploads/{{ $custom_notification->image }}" alt="">
                                                @else
                                          ...
                                          <input id="image_url" type='hidden' name='image' value="{{ $custom_notification->image }}">
                                        </div>  

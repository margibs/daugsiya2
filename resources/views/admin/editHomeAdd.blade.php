...
.form-group input[type=text], .form-group textarea, .form-group select, .form-group .form-control{
...
@include('admin.navigations.homeImageNav')
				...
				<!--   <form action="{{ url('admin/homeads/edit') }}/{{ $home_image->id }}" method="POST" class="form-horizontal"> -->
          {!! Form::model($home_image, array('class' => 'form-horizontal', 'url' => array('admin/homeads/edit',  $home_image->id))) !!} 
						...
						<div class="col-xs-12 col-lg-6" style="padding: 20px 40px;">
							<div class="panel">
								...
								<div class="form-group">
									<h6> Link </h6> 
									<input type="text" class="form-control" name="link" value="{{ $home_image->link }}">
								</div>

								<div class="form-group">
									<h6> Redirect Link </h6> 
									<input type="text" class="form-control" name="redirect_link" value="{{ $home_image->redirect_link }}">
								</div>
<div class="form-group">
                ...
                [
                  ...
                  'ZM' => 'Zambia',
                  'ZW' => 'Zimbabwe',
                ],  $home_image->country_code, ['data-placeholder' => 'Choose a Country...','class' => 'chosen-select','style' => 'width:350px;']) !!}
</div>
								<div class="form-group">
									<h6> Position </h6> 
									<!-- <input type="number" class="form-control" name="position" value="{{ $home_image->position }}"> -->
									@if( $home_image->is_boolean == '1')
								...
								<div class="form-group">
									<h6> show Banner </h6>
							<!--   <input name="show_banner" type="checkbox" value="{{ $home_image->show_add}}"> -->
              
    
                      @if($home_image->show_add == 1 && $home_image->show_add == '1' && $home_image->show_add == true)
                        <input type="checkbox" name="show_banner" id="show_banner" value="{{ $home_image->show_add }}" checked><br>
                        @else
                          <input type="checkbox" name="show_banner" id="show_banner" value="{{ $home_image->show_add }}" ><br>
                        @endif
								...
								<div class="form-group">
									<div class="panel">
										  <h6> 
										   ...
										   <div id="img_here">
										   @if($home_image->image)
												<img src="{{ url('uploads') }}/{{ $home_image->image }}" alt="">
											@else
									...
									<input id="image_url" type='hidden' name='image' value="{{ $home_image->image }}">
								</div>		

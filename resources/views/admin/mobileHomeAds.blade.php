...
@include('admin.navigations.homeImageNav')
					...
					<div class="row">	
						<div class="col-xs-12 col-lg-6" style="padding: 20px 40px;">
							<div class="panel">
			                	<h2> New Mobile Home Ads </h2>	
								
									<input id="is_boolean" type='hidden' name='is_boolean' value="1">
								...
								<div class="form-group">
									<h6> Redirect Link </h6> 
									<input type="text" class="form-control" name="redirect_link" value="{{old('redirect_link')}}">
								</div>
								<div class="form-group">

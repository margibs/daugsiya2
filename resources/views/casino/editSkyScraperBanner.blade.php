...
<div class="panel">
  <h6> 
    ...
    <i class="icon-line-plus"></i> Article Banner Image  </a> 
  </h6>         
   <div id="img_here">
    <img src="{{url('uploads')}}/{{ $articleBanner->image_url }}" alt="" style="width: auto; height: auto;">
  </div>   
</div>
...
<form action="{{url('admin/skyscraper_banner')}}/{{ $articleBanner->id }}" method="post">
 ...
 {{--  {!! Form::select('countries[]', 
  ...
  {!! Form::select('priority', $priority_list ,$articleBanner->priority) !!}
	<input name="show_banner" type="checkbox" value="1" @if($articleBanner->show_banner) checked @endif>  Show Banner <br>

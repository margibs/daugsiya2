...
@include('casino.__navigation')
  ...
  <h6> 
    ...
    <i class="icon-line-plus"></i> Skyscraper Banner Image  </a> 
  </h6>         
   <div id="img_here">
    @if(old('image_url'))
...
@endif
<form action="{{url('admin/skyscraper_banner')}}" method="post">
	{!! csrf_field() !!}
  ...
  {!! Form::select('priority', $priority_list ,old('priority')) !!}
	<input name="show_banner" type="checkbox" value="1">  Show Banner <br>
